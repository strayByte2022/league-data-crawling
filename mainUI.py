...
# enter api
api_label = tk.Label(root, font=('System', 13), text="Riot's API key: ")
...
# enter username
userName_label = tk.Label(root, font=('System', 13), text="User name: ")
...
options = ['--Select-- ', 'BR1', 'EUN1', 'EUW1', 'JP1', 'KR', 'LA1', 'LA2', 'NA1', 'OC1', 'PH2', 'RU', 'SG2', 'TH2',
           'TR1', 'TW2',
           'VN2']
region_label = tk.Label(root, font=('System', 13), text="Select region: ")
...
# number of matches
num_of_match_label = tk.Label(root,font=('System',13),text='Number of matches (1-100): ')
num_of_match_label.grid(row=2,column=0,pady=(10,0))
num_of_match_box = tk.Entry(root, font=('System',13))
num_of_match_box.grid(row=2,column=1,sticky='WS')
# click button
